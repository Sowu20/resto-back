...
router.get('/commande/admin/statorder', auth, admincommandeController.getCommandesStats);
router.get('/commande/admin/listcommande', auth, admincommandeController.getlistCommande);
