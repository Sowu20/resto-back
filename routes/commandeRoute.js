...
router.get('/commande/admin/statorder', auth, role(['Admin']), admincommandeController.CommandesStats);
...
router.get('/commande/admin/total_customers', auth, role(['Admin']), admincommandeController.totalCustomers);
